...
| `docs/project/RELEASE_NOTES_6.6.0.md` | project | active | true | craftbuddy-maintainers | keep-authoritative |
| `docs/project/RELEASE_NOTES_6.7.0.md` | project | active | true | craftbuddy-maintainers | keep-authoritative |
...
| `docs/project/WORKSTREAM_OWNERSHIP.md` | project | active | true | craftbuddy-maintainers | keep-authoritative |
...
| `docs/reference/afnm-crafting-guide/mechanics_calculations.md` | 1 |
| `docs/reference/afnm-crafting-guide/realm_progressions.md` | 1 |
