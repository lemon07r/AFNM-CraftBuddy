---
title: Crafting Reference Shortlist
status: reference
authoritative: false
owner: craftbuddy-maintainers
last_verified: 2026-02-07
source_of_truth: curated shortlist for CraftBuddy-relevant imported docs
...
- `docs/reference/afnm-modding/concepts/modapi.md`
- `docs/reference/afnm-modding/concepts/scaling.md`
- `docs/reference/afnm-modding/crafting/index.md`
...
- broad event/quest/location/character authoring docs unless task explicitly touches those systems
